...
dalmore12 = Bottle.create(distillery_id: dalmore.id, user_id: gian.id, name: "Dalmore 12", origin: "Scotland(Highlands)", year: "12", price: 65, rating: 94, image_url: "https://img.thewhiskyexchange.com/900/dlmob.non19.jpg")
macallan12 = Bottle.create(distillery_id: macallan.id, user_id: gian.id, name: "Macallan 12 Double Cask", origin: "Scotland(Speyside)", year: "12", price: 70, rating: 95, image_url: "https://products0.imgix.drizly.com/ci-macallan-double-cask-12-year-a4ae339333522654.jpeg?auto=format%2Ccompress&ch=Width%2CDPR&fm=jpg&q=20")
...
white = Bottle.create(distillery_id: walker.id, user_id: gian.id, name: "Johnnie Walker White Walker", origin: "Scotland(Speyside)", year: "non-aged statement", price: 35, rating: 65, image_url: "https://cdn.shopify.com/s/files/1/0055/5125/9719/products/rSL000075.jpg?v=1678332244")
